...
蓍草起卦需要手动将蓍草进行分堆，脚本使用正态分布及随机标准差模拟手动分堆。连续计算六次，根据结果形成本卦、进而定之卦、互卦、世爻、应爻以及六爻五行。

目前已将其制作成Claude code可使用的skill，可基于Claude code实现起卦解卦一体流程。详见：https://github.com/Sheaffer-triumph/ZhouyiDivination
